...
fetch();
  ...
  {
    ProfileData && (
        <div className="h-[100%] p-0 md:p-4 text-zinc-900">

<h1 className=" text-3xl md:text-5xl font-semibold text-zinc-700 mb-8">
...
<p className= "p-2 rounded bg-zinc-200 mt-2 font-semibold">
...
className ="p-2 rounded bg-zinc-200 mt-2 font-semibold"
